...
//        params.put("commonParamsKey2", "这里支持中文参数");
        ...
        //超时时间设置，默认60秒
        builder.readTimeout(40000, TimeUnit.MILLISECONDS);      //全局的读取超时时间
        builder.writeTimeout(40000, TimeUnit.MILLISECONDS);     //全局的写入超时时间
        builder.connectTimeout(40000, TimeUnit.MILLISECONDS);   //全局的连接超时时间
